...
namespace EshoppingV2._0.Controllers
{
    public class SpecialOffersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,offerName,discount,startDate,endDate,MinQ,MaxQ,description")] SpecialOffer specialOffer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,offerName,discount,startDate,endDate,MinQ,MaxQ,description")] SpecialOffer specialOffer)
        {
            if (ModelState.IsValid)
            {
